<template>
    <hy-config-provider :theme-color="color" :theme="darkMode">
        <hy-folding-panel
            ...
            :size="size"
        >
            <hy-folding-panel-item title="水果" index="fruits"> 内容一 </hy-folding-panel-item>
            <hy-folding-panel-item title="主食" index="food" disabled>
                内容二
            </hy-folding-panel-item>
            <hy-folding-panel-item title="饮品" index="beverage" value="奶茶" :default-open="true">
                内容三
            </hy-folding-panel-item>
